...
var (
	...
	rpcConfigFileJSON      = "<load-configuration format=\"json\"><configuration-json>%s</configuration-json></load-configuration>"
	...
	rpcConfigStringJSON    = "<load-configuration format=\"json\"><configuration-json>%s</configuration-json></load-configuration>"
